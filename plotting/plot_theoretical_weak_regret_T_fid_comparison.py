...
ax1.plot(df_4000['T'], df_4000['average_divided_by_promise'], marker='o', color='#6D6')
ax1.plot(df_5000['T'], df_5000['average_divided_by_promise'], marker='o', color='#8F8')

ax1.set_xlabel('T')
ax1.set_xscale('log')
ax1.set_ylabel('weak regret / expected regret bound')
ax1.set_title(f"FID regret plot for k=10")
